...
setuptools.setup(
    name='pollination-three-phase',                                     # will be used for package name unless it is overwritten using __queenbee__ info.
    ...
    url='https://github.com/pollination/three-phase',                   # will be translated to home
    project_urls={
    ...
    description='Three phase recipe for Pollination.',                  # will be used as package description
    long_description=long_description,                                      # will be translated to ReadMe content on Pollination
    long_description_content_type="text/markdown",
    maintainer='ladybug-tools',                                   # Package maintainers. For multiple maintainers use comma
    maintainer_email='info@ladybug.tools',
    keywords='honeybee, radiance, ladybug-tools, daylight, three-phase',# will be used as keywords
